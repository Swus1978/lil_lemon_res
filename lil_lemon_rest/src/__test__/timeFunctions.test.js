import { updateTimes, initializeTimes } from '../path/to/timeFunctions'; // Adjust the path based on your folder structure
...
test('initializeTimes returns the expected value', () => {
    ...
    const expectedTimes = ['11:00','12:00','13:00','14:00','15:00','16:00','17:00', '18:00', '19:00', '20:00', '21:00', '22:00','23:00'];
